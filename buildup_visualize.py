#지금 셀에 작성한 내용을 buildup_visualize.py라는 파이썬 파일로 저장
...
def build_bot_detection_dataset():
  ...
  # 시계열 데이터 봇 데이터
  bot_1 = np.random.normal(0,0.001, (50, 100)) # 평균0 표준편차0.001 50행 100열
  ...
  # [4] 최종 결합 : 데이터 (100) + 표준편차(1) + 레이블(1) => (160, 103)
  dataset = np.column_stack(((X_data, row_stds, y_data)))
